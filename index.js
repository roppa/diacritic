/* just copy utils function for now - global */
module.exports = {
    ...
    removeSymbols : function (str) {
        if (typeof str !== "string") return str;
        for(var i = 0; i < this.defaultSymbolRemovalMap.length; i++) {
            str = str.replace(this.defaultSymbolRemovalMap[i].symbols, this.defaultSymbolRemovalMap[i].base);
        }
